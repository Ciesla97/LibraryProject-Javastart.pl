...
import pl.javastart.library.exception.PubliactionsAlreadyExistsException;
...
public class Library implements Serializable {
    ...
    public void addPublication(Publication publication){
        if(publications.containsKey(publication.getTitle())) {
            throw new PubliactionsAlreadyExistsException(
                    "Publikacja o takim tytule już istnieje"
            );
        }
